...
<div class=" row justify-content-center" >
	<div class="col-lg-6">
		<center><h3>Edit Data Penduduk</h3></center><br>
	<form action =" /penduduk/{{ $penduduks->id }}" method="post">
        @method('PUT')
		@csrf
		<div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">NIK</label>
                <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" value="{{old('nik',$penduduks->nik)}}">
                @error('nik')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{old('nama',$penduduks->nama)}}">
                @error('nama')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-row row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="date" placeholder="Enter Tanggal Lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir',$penduduks->tanggal_lahir) }}" id="tanggal_lahir" name="tanggal_lahir">
                    </div>
		    ...
		    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3">{{ old('alamat',$penduduks->alamat)}}</textarea>
		        @error('alamat')
		  	        <div class="invalid-feedback">
		  		        {{$message}}
		  	        </div>
                ...
                <div class="form-row row">
                    <div class="col-md-12">
                        ...
                        <input type="text" placeholder="Enter Telepon" class="form-control @error('telp') is-invalid @enderror" value="{{ old('telp',$penduduks->telp) }}" id="telp" name="telp">
                    </div>
                </div>
                @error('telp')
                <div class="invalid-feedback">
